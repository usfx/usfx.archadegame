...
public class Model 
{
    ...
    public int BALL_SIZE      = 20;     // Ball side changed
    ...
    public int HIT_BOTTOM     = -50;   // Score (penalty) for hitting the bottom of the screen
    public int LOSE_LIFE     = -1;   // penalty for for hitting the bottm
    ...
    {       
        ...
        int WALL_TOP5 = 250;                     // how far down the screen the wall starts
        int NUM_BRICKS5 = width/BRICK_WIDTH;     // how many bricks fit on screen
        for (int i=0; i < NUM_BRICKS5; i++) {
            GameObj brick = new GameObj(BRICK_WIDTH*i, WALL_TOP5, BRICK_WIDTH, BRICK_HEIGHT, Color.GREEN);
            bricks.add(brick); // add this brick to the list of bricks
        }
        
        int WALL_TOP7 = 225;                     // how far down the screen the wall starts
        int NUM_BRICKS7 = width/BRICK_WIDTH;     // how many bricks fit on screen
        for (int i=0; i < NUM_BRICKS7; i++) {
            GameObj brick = new GameObj(BRICK_WIDTH*i, WALL_TOP7, BRICK_WIDTH, BRICK_HEIGHT, Color.PINK);
            bricks.add(brick); // add this brick to the list of bricks
        }
        ...
        int WALL_TOP4 = 220;                     // how far down the screen the wall starts
        int NUM_BRICKS4 = width/BRICK_WIDTH;     // how many bricks fit on screen
        for (int i=0; i < NUM_BRICKS4; i++) {
            GameObj brick = new GameObj(BRICK_WIDTH*i, WALL_TOP4, BRICK_WIDTH, BRICK_HEIGHT, Color.PINK);
            bricks.add(brick); // add this brick to the list of bricks
        }
        
        
        
        int WALL_TOP6 = 195;                     // how far down the screen the wall starts
        int NUM_BRICKS6 = width/BRICK_WIDTH;     // how many bricks fit on screen
        for (int i=0; i < NUM_BRICKS6; i++) {
            GameObj brick = new GameObj(BRICK_WIDTH*i, WALL_TOP6, BRICK_WIDTH, BRICK_HEIGHT, Color.SILVER);
            bricks.add(brick); // add this brick to the list of bricks
        }
        
        
        
        int WALL_TOP3 = 190;                     // how far down the screen the wall starts
        int NUM_BRICKS3 = width/BRICK_WIDTH;     // how many bricks fit on screen
        for (int i=0; i < NUM_BRICKS3; i++) {
            GameObj brick = new GameObj(BRICK_WIDTH*i, WALL_TOP3, BRICK_WIDTH, BRICK_HEIGHT, Color.RED);
            bricks.add(brick); // add this brick to the list of bricks
        }
        
        int WALL_TOP1 = 160;                     // how far down the screen the wall starts
        int NUM_BRICKS1 = width/BRICK_WIDTH;     // how many bricks fit on screen
        for (int i=0; i < NUM_BRICKS1; i++) {
            GameObj brick = new GameObj(BRICK_WIDTH*i, WALL_TOP1, BRICK_WIDTH, BRICK_HEIGHT, Color.BLACK);
            bricks.add(brick); // add this brick to the list of bricks
        }
        int WALL_TOP2 = 130;                     // how far down the screen the wall starts
        int NUM_BRICKS2 = width/BRICK_WIDTH;     // how many bricks fit on screen
        for (int i=0; i < NUM_BRICKS2; i++) {
            GameObj brick = new GameObj(BRICK_WIDTH*i, WALL_TOP2, BRICK_WIDTH, BRICK_HEIGHT, Color.RED);
            bricks.add(brick); // add this brick to the list of bricks
        }
        // *[1]******************************************************[1]*
    ...
    public synchronized void updateGame()
    {
        ...
        { 
            ...
            addToLife( LOSE_LIFE);      // life penalty for hitting bottom
        }
    ...
    // update life
    public synchronized void addToLife(int z)    
    {
        life += z;        
    }
